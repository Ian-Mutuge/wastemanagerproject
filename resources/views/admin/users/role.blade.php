...
<body class="antialiased bg-gray-100 dark-mode:bg-gray-900">
    ...
    <a href="{{route('admin.users.index')}}" style="background-color: #167F92;" onmouseover="this.style.backgroundColor='#0F4B59';" onmouseout="this.style.backgroundColor='#167F92';" class="px-4 py-2 bg-green-70 hover:bg-green-500 rounded-md">Users Index</a>
</div>
...
<form method="POST" action="{{route('admin.users.roles.remove',[$user->id,$user_role->id])}}" onsubmit="return confirm('Are you sure?');">
    @csrf
    @method('DELETE')
    <button type="submit" style="background-color: #167F92;" onmouseover="this.style.backgroundColor='#0F4B59';" onmouseout="this.style.backgroundColor='#167F92';" class="px-4 py-2 bg-green-500 hover:bg-green-700 rounded-md">{{$user_role->name}}</button>
    </form>
@endforeach
@endif
</div>
...
<form method="POST" action="{{route('admin.users.permissions.revoke',[$user->id,$user_permission->id])}}" onsubmit="return confirm('Are you sure?');">
    @csrf
    @method('DELETE')
    <button type="submit" style="background-color: #167F92;" onmouseover="this.style.backgroundColor='#0F4B59';" onmouseout="this.style.backgroundColor='#167F92';" class="px-4 py-2 bg-green-500 hover:bg-green-700 rounded-md">{{$user_permission->name}}</button>
    </form>
@endforeach
@endif
</div>
