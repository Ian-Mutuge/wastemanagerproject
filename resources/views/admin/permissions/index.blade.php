...
<body class="antialiased bg-gray-100 dark-mode:bg-gray-900">
    ...
    <a href="{{route('admin.permissions.create')}}" style="background-color: #167F92;" onmouseover="this.style.backgroundColor='#0F4B59';" onmouseout="this.style.backgroundColor='#167F92';" class="px-4 py-2 bg-green-70 hover:bg-green-500 rounded-md">Create Permissions</a>
</div>
